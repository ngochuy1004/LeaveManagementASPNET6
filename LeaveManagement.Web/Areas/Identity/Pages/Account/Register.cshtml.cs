    ...
    public class RegisterModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                //?? mean that can use or not use Model binding properties if null that get default value
                user.DateOfJoined = Input.DateOfJoined ?? default;
                user.DateOfBirth = Input.DateOfBirth ?? default;

                //create a user then assign identifer for it, guarentees that identifer is IAlwaysRunResultFilter unique
